...
<head>
	...
	<title>2MG - NANO4PREMIUMTEXTILE - NANO4LIFE PERÚ</title>
		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				<div class="titulo-producto-xado">
					<h1>NANO4PREMIUM TEXTILE - NANO4LIFE PERÚ</h1>
				</div>

				<div class="fondo-azul-xado">
					<p>Protección 100% invisible para los tejidos más gruesos. Protege los tejidos y evita la decoloración debida a los rayos ultra-violeta, aumentando la vida útil de los mismos. Previene la formación de manchas, tanto provocadas por “agentes” agresivos, como por mohos, aceite, café o vino. Con un elevado rendimiento, permite ahorrar tiempo y dinero, posibilitando reducir hasta un 90% la utilización de productos de limpeza. Bastará después enjuagar con agua para mantener el tejido limpio.</p>
				</div>
			...
			<ul>
				<li><span>Todo tipo de tejidos, incluyendo tapetes, sofás y otros tejidos gruesos.</span></li>
...
<h3>Documentación: </h3>
			...
			<ul>
				<li><span>	<a href="pdf/premiumtextile-nano4life.pdf" target="_blank">Ficha técnica</a></span></li>
