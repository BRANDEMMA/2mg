...
<head>
	...
	<title>2MG - NANO4YATCH - NANO4LIFE PERÚ</title>
		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				<div class="titulo-producto-xado">
					<h1>NANO4YATCH - NANO4LIFE PERÚ</h1>
				</div>

				<div class="fondo-azul-xado">
					<p>Protección 100% invisible de las superfícies exteriores de los barcos, facilitando la eliminación de todo tipo de acumulación de suciedad. Proporciona una barrera contra los rayos ultra-violeta que prolonga la vida de la pintura durante unos cuantos años más. Presenta gran resistencia química y mecánica, siendo resistente al hielo y a lavados con un chorro de agua a presión. Con un elevado rendimiento, permite ahorrar tiempo y dinero, posibilitando reducir hasta un 90% la utilización de productos de limpieza.</p>
				</div>
			...
			<ul>
				<li><span>Superfícies exteriores de barcos.</span></li>
...
<h3>Documentación: </h3>
			...
			<ul>
				<li><span>	<a href="pdf/yacht-nano4life.pdf" target="_blank">Ficha técnica</a></span></li>
			</ul>
