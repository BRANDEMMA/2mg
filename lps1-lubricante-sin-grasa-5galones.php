...
<head>
	...
	<title>2MG - LPS 1 LUBRICANTE SIN GRASA 5 GALONES</title>
		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				<div class="titulo-producto-xado">
					<h1>LPS 1 Lubricante Sin Grasa de 5 Galones</h1>
				</div>

				<div class="fondo-azul-xado">
					<p>Lubricante sin grasa.<br><br>
					Proporciona una, delgada película lubricante seca.<br><br>
					Resiste el aceite, polvo y la acumulación de suciedad.<br><br>
					Ideal para mecanismos delicados.<br><br>
					Elimina la acumulación de carbón de las superficies.<br><br>
					Desplaza la humedad.<br><br>
					Seguro en la pintura, la tela, y la mayoría de plásticos.<br><br>
					Utilizado en la aviación.</p>
				</div>
