			...
			<div class="derecha-nosotros-centrado">
				...
				<div class="fondo-formulario">
					...
					<div class="contenido-form-sorteo">
						...
						<form class="form-main formulario-sorteo" name="ajax-form" id="ajax-form" method="POST" action="php/registrar-empresa.php">
							...
							<div class="campos-formulario">
								<label>RUC:</label><br>
								<input name="ruc" id="ruc" type="tel" required>
							</div>
