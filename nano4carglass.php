		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				...
				<div class="fondo-azul-xado">
					<p>Protección 100% invisíble, que impide la adherencia de líquidos y suciedad al pára-brisas y vidrios del automóvil, mejorando la visibilidad con lluvia y facilitando la eliminación del hielo. Presenta grand resistencia química y mecánica, siendo resistente a lavados con chorro de agua caliente a presión. Con un alto rendimento, permite una economia de tiempo y dinero: posibilitando reducir hasta el 90% la utilización de productos de limpeza.</p>
				</div>
			...
			<h3>Descripción</h3>
			<ul>
				<li><span>Lugares de aplicación: Cristales de todo  tipo de vehículos.</span></li>
