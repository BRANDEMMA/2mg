...
<head>
	...
	<title>2MG - NANO4CARGLASS  - NANO4LIFE PERÚ</title>
		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				...
				<div class="fondo-azul-xado">
					<p>Protección 100% invisíble, que impide la adherencia de líquidos y suciedad al parabrisas y otros cristales del automóvil, mejorando la visibilidad con lluvia y facilitando la eliminación del hielo. Presenta gran resistencia química y mecánica, siendo resistente a lavados con un chorro de agua caliente o vapor a presión. Con un elevado rendimiento, permite ahorrar tiempo y dinero, posibilitando reducir hasta un 90% la utilización de productos de limpieza.</p>
				</div>
...
<h3>Lugares de aplicación: </h3>
			<ul>
				<li><span>Todos los tipos de parabrisas de vehículos.</span></li>
			...
			<ul>
				<li><span>	<a href="pdf/carglass-nano4life.pdf" target="_blank">Ficha técnica</a></span></li>
