		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				...
				<div class="fondo-azul-xado">
					<p>Protección 100% invisíble, que impide la adherencia de líquidos y suciedad en las superfícies plásticas. Protege contra la acción de los rayos ultra-violeta. Presenta gran resistencia química y mecánica, siendo resistente al hielo y a lavados con chorro de agua de alta presión (50 – 60 bar). Con elevado rendimento, permite ahorrar tiempo y dinero: Es posible reducir hasta el 90% la utilización de productos de limpieza.</p>
				</div>
