		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				...
				<div class="fondo-azul-xado">
					<p>Producto 3 en 1 que efectua limpieza, pulimento y protección.<br><br>
					LIMPIEZA: Por acción de los potentes componentes nanotecnológicos, elimina a fondo todo  tipo de suciedades, que puedan existir en la carrocería del vehículo.<br><br>
					PULIMENTO: Tiene componentes que cubren rayones provocados por los lavados y otros en la pintura, consiguiendo una superfície brillante y devolviendo la apariencia de cuando era nuevo.<br><br>
					PROTECCIÓN: El poder de las nanopartículas de SiO2 repele líquidos e impide la adhesión de polvo, sustancias aceitosas y otros tipos de suciedades.</p>
				</div>
			...
			<h3>Descripción</h3>
			<ul>
				<li><span>Lugares de aplicación: Superfícies pintadas de los vehículos.</span></li>
				<li><span>Versiones comercializadas: Única</span></li>
				<li><span>Embalajes: 500mL; 1000mL; e 4L</span></li>
			</ul>
