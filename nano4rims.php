...
<head>
	...
	<title>2MG - NANO4RIMS - NANO4LIFE PERÚ</title>
		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				<div class="titulo-producto-xado">
					<h1>NANO4RIMS - NANO4LIFE PERÚ</h1>
				</div>

				<div class="fondo-azul-xado">
					<p>Protección 100% invisible, que impide la adherencia de líquidos y suciedades a las llantas, confiriendo brillo y dando aspecto de nuevo a la llanta. Confiere protección prolongada contra la radiación ultra-violeta. Presenta gran resistencia química y mecánica, siendo resistente al hielo y a los lavados con un chorro de agua caliente o vapor a presión.  Con un elevado rendimiento, permite ahorrar tiempo y dinero, posibilitando reducir hasta un 90% la utilización de productos de limpeza.</p>
				</div>
...
<h3>Documentación: </h3>
			...
			<ul>
				<li><span>	<a href="pdf/rims-nano4life.pdf" target="_blank">Ficha técnica</a></span></li>
