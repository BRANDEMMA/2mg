...
<head>
	...
	<title>2MG - REPRESENTAÇÕES COMERCIAIS</title>
	<meta name="author" content="Brandemma" />
	<meta name="description" content="2MG oferece serviços e soluções de revenda Representantes e materiais comerciais. Execução de soluções imediatas para a área de logística. Nós oferecemos soluções em industrial, produtos químicos e peças de reposição para fornecimento de equipamentos." />
...
<body>
	...
	<div class="contenido"><h1 class="titulo-arriba">Representações <span>Comerciais</span></h1>
		<div class="representaciones-comerciales linea-energetica">
			...
			<div class="izquierda-representaciones">
				<h2>Representações <strong>Comerciais </strong></h2>
				<p>Oferecemos o <strong>serviço e solução de representação comercial e revenda de materiais</strong>, produtos e consumíveis para e indústria em geral.<br>
				Temos capacidade de atender o mercado de acordo com a necessidade especifica do cliente, <strong>garantindo o cumprimento de prazos</strong>, evitando as perdas por redução em produtividade.</p>

				<ul id="accordion" class="accordion">
				<li>
					<div class="link"><span>&#62;</span> Fornecimentos <strong>Industriais</strong><a class="descarga-dossier" href="pdf/industria.pdf" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;&nbsp;DOSSIER</a></div>
				...
				<li>
					<div class="link"><span>&#62;</span> Insumos <strong>Químicos</strong><a class="descarga-dossier" href="pdf/quimica.pdf" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;&nbsp;DOSSIER</a></div>
					<ul class="submenu">
						<li>
				...
				<li>
					<div class="link"><span>&#62;</span> Peças sobressalentes para <strong>Equipamento</strong><a class="descarga-dossier" href="pdf/logistica.pdf" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp;&nbsp;DOSSIER</a></div>
					<ul class="submenu">
						<li>
			...
			<div class="derecha-representaciones">
				<div class="contenedor-formulario">
					<div class="titulo">
						<h2>SOLUCOES IMEDIATAS</h2>	
					</div>
					<div class="contenido-formulario">
						<p>Sabemos muito bem as emergências que ocorrem na área de negócios de logística, que é por isso que nós fornecemos o serviço <strong> soluções imediatas </ strong>. Este serviço irá ajudá-lo a encontrar os suprimentos específicos necessários urgentemente.<br>
						O nosso compromisso é encontrar e atender a sua reunião de negócios dos prazos previamente estabelecidos.</p>
						<div class="formulario">
							<h4>ENVIE-NOS AS SUAS NECESSIDADES</h4>
							<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/mensaje-contacto2.php">
								<div class="centrado verde2" id="ajaxsuccess2">*O e-mail foi enviado com sucesso.*</div>

								<div class="campos-formulario">
									<label>NOME</label><br>
									<input name="nombre" id="nombre" type="text" onfocus="if(this.value == 'Nombre') this.value='';" onblur="if(this.value == '') this.value='';">
									<div class="clear"></div>
									<div class="error2 centrado" id="err-nombre">*Digite seu nome*</div><br>
								</div>
								...
								<div class="campos-formulario">
									...
									<div class="clear"></div>
									<div class="error2 centrado" id="err-email">*Digite seu e-mail*</div>
								    <div class="error2 centrado" id="err-emailvld">*O formato de E-mail é inválido*</div><br>
							    </div>
								...
								<div class="campos-formulario">
									...
									<div class="clear"></div>
									<div class="error2 centrado" id="err-empresa">*Por favor, indique o nome da empresa*</div><br>
								</div>

								<div class="mensaje-formulario">
								<label>REQUISITO / DESCRIÇÃO</label><br>
									...
									<div class="clear"></div>
									<div class="error2 centrado" id="err-mensaje">*Por favor, indique uma mensagem*</div><br>
								</div>

								<div class="clear"></div>

								<div class="error2 centrado" id="err-form">*Houve um problema validar o formulário por favor, verifique!*</div>
								<div class="error2 centrado" id="err-timedout">*Conexão em tempo para o servidor expirou!*</div>
