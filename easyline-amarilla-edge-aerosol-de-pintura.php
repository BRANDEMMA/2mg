...
<head>
	...
	<title>2MG - EASYLINE EDGE AEROSOL DE PINTURA (AMARILLA)</title>
		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				<div class="titulo-producto-xado">
					<h1>EASYLINE® Edge aerosol de pintura</h1>
				</div>

				<div class="fondo-azul-xado">
					<p>El marcado líneas líder en el mercado de aerosol de tinta.<br><br>

					El EASYLINE® Edge se acepta como las mejores líneas de marcado de aerosol de tinta en el mundo. Con una formulación de pintura superior combinada con una precisión aplicador EASYLINE® Edge se garantiza que el sistema de Edge produce líneas nítidas, mercado más brillante y más durable. Disponible en ocho colores RAL y dos colores fluorescentes, la EASYLINE ® Edge es una pintura epoxi adecuada para el tráfico extremadamente durable, ideal para marcar líneas y marcar la mano, tanto en interiores como en exteriores.</p>
				</div>
