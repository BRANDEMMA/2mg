...
<head>
	...
	<title>2MG - NANO4BATHCARE - NANO4LIFE PERÚ</title>
		...
		<div class="descripcion-xado">
			...
			<div class="detalle-producto-xado-der">
				...
				<div class="fondo-azul-xado">
					<p>Protege las superfícies a través de una barrera 100% invisíble que impide la adherencia de suciedad y formación de manchas, permitiendo la eliminación de restos de cal usando un simple paño húmedo con água. Consigue una protección anti-bacteriana y presenta gran resistencia química y mecánica. Posee un elevado rendimento, permite economizar tiempo y dinero: posibilitando reducir hasta el 90% la utilización de materiales de limpieza.</p>
				</div>
			...
			<ul>
				<li><span>	<a href="pdf/bathcare-nano4life.pdf" target="_blank">Ficha técnica</a></span></li>
